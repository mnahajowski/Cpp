...
template< typename T >
void  v_tree_test(CNodeDynamic<T> *c_root) {
...
template< typename T >
void  v_tree_test3(CNodeDynamic<T> *c_root) {


	c_root->vAddNewChild();
	c_root->vAddNewChild();
	//std::cout << x << "\n";
	c_root->pcGetChild(0)->vSetValue(1.5);
	c_root->pcGetChild(1)->vSetValue(2);
...
template< typename T >
void  v_tree_test2(CNodeDynamic<T> *c_root) {
	...
	c_root->pcGetChild(0)->pcGetChild(0)->vSetValue("B");
	c_root->pcGetChild(0)->pcGetChild(1)->vSetValue("B");
	/*
	c_root->pcGetChild(1)->vAddNewChild();
	c_root->pcGetChild(1)->vAddNewChild();
...
int main()
{
	//CTreeDynamic<int> *obj8 = new CTreeDynamic<int>();
	//CNodeDynamic<int> *c_root = new CNodeDynamic<int>();
	/*
	CTreeDynamic<int> *obj8 = new CTreeDynamic<int>();
	
	obj8->vSetRoot(new CNodeDynamic<int>());
	
	v_tree_test(obj8->pcGetRoot());
	obj8->vPrintTree();
	std::cout<<" " << obj8->sGetKnownType();
	...
	v_tree_test(obj8->pcGetRoot());
	//obj8->vPrintTree();
	obj8->pcGetRoot()->wypisz2(0);



	CTreeDynamic<double> *obj9 = new CTreeDynamic<double>();

	obj9->vSetRoot(new CNodeDynamic<double>());

	v_tree_test(obj9->pcGetRoot());
	//obj9->vPrintTree();
	obj9->pcGetRoot()->wypisz2(0);


	
	CTreeDynamic<std::string> *obj10 = new CTreeDynamic<std::string>();

	obj10->vSetRoot(new CNodeDynamic<std::string>());
	//obj10->vPrintTree();
	v_tree_test2(obj10->pcGetRoot());
	//obj10->pcGetRoot()->vPrintAllBelow();
	//obj10->vPrintTree();
	...
	/*
	CTreeDynamic<double> *obj10 = new CTreeDynamic<double>();

	obj10->vSetRoot(new CNodeDynamic<double>());
	v_tree_test(obj10->pcGetRoot());
	std::cout << "\n";
	obj10->vPrintTree();
	std::cout<<obj10->sGetKnownType();
	delete obj10;*/
